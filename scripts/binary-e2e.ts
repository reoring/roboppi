...
const instructions = "Create countdown.ts. It should accept a number N from CLI args, count down from N to 1, then print Liftoff!. Example: bun run countdown.ts 5 -> 5,4,3,2,1,Liftoff!";

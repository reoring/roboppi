/**
 * Agent task housekeeping unit tests (Spec 3.3).
 *
 * Covers:
...
import { addTask, claimTask } from "../../../src/agents/task-store.js";
import { housekeepTasksInProgress } from "../../../src/agents/housekeeping.js";
import { tasksStatusDir, tasksEventsPath } from "../../../src/agents/paths.js";

let contextDir: string;

beforeEach(async () => {
  contextDir = await mkdtemp(path.join(tmpdir(), "agents-task-hk-"));

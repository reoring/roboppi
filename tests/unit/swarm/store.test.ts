/**
 * Swarm Store — mailbox semantics unit tests.
 *
 * Covers design §11.1:
...
import { housekeepMailbox } from "../../../src/swarm/housekeeping.js";
import {
  inboxNew,
  inboxProcessing,
  inboxCur,
...
beforeEach(async () => {
  contextDir = await mkdtemp(path.join(tmpdir(), "swarm-store-test-"));

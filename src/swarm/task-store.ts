/**
 * Swarm Task Store — race-free task state transitions via rename().
 *
 * See `docs/features/swarm.md` §5.3 and §6.1.2.
 */
...
import type { SwarmTask, TaskStatus } from "./types.js";
 ...
 * segments.  This prevents path-traversal when `roboppi swarm` is exposed
